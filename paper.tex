...
% A snippet of the \emph{1 to 1} and \emph{1 to 3} policies is shown in \autoref{fig:policy-snippet}.
...
%     \end{lstlisting}
%   \end{minipage}
%   \caption{Snippets of the \emph{1 to 1} and \emph{1 to 3} policies used for benchmarking.}
